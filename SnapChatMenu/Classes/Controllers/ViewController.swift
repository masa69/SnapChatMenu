...
class ViewController: UIViewController {
    ...
    private func initPVCAnimation(currentIndex: Int) {
        ...
        self.animations.append(animation: PVCAnimation(
            ...
            styles: [
                PVCAnimationStyle(thenIndexForLabel: 0, delay: 0.5, forward: 0.0, color: .white, border: .none, constraint: [0]),
                PVCAnimationStyle(thenIndexForLabel: 1, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
                PVCAnimationStyle(thenIndexForLabel: 2, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
                PVCAnimationStyle(thenIndexForLabel: 3, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
            ]
        ))
        self.animations.append(animation: PVCAnimation(
            textIndex: 1, label: centerTitleLabel, constraint: [centerTitleConstraint],
            styles: [
                PVCAnimationStyle(thenIndexForLabel: 0, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
        ...
        self.animations.append(animation: PVCAnimation(
            ...
            styles: [
                PVCAnimationStyle(thenIndexForLabel: 0, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
                PVCAnimationStyle(thenIndexForLabel: 1, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
                PVCAnimationStyle(thenIndexForLabel: 2, delay: 0.5, forward: 0.0, color: .white, border: .none, constraint: [0]),
                PVCAnimationStyle(thenIndexForLabel: 3, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
            ]
        ))
        self.animations.append(animation: PVCAnimation(
            ...
            styles: [
                ...
                PVCAnimationStyle(thenIndexForLabel: 1, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
                PVCAnimationStyle(thenIndexForLabel: 2, delay: 0.0, forward: 0.6, color: .clear, border: .none, constraint: [-20]),
                PVCAnimationStyle(thenIndexForLabel: 3, delay: 0.5, forward: 0.0, color: .black, border: .none, constraint: [0]),
            ]
        ))
        ...
        self.animations.append(animation: PVCAnimation(
            ...
            badge: PVCAnimationBadge(frame: badgeFrame, color: nil),
            view: leftView, constraint: [leftConstraint, leftBottomConstraint],
            styles: [
                PVCAnimationStyle(thenIndex: 0, delay: 0.0, forward: 0.0, color: .lightGray, border: .none, size: 24.0, constraint: [centerMargin, margin]),
                PVCAnimationStyle(thenIndex: 1, delay: 0.0, forward: 0.0, color: .white, border: .shadow, size: 30.0, constraint: [margin, margin]),
                PVCAnimationStyle(thenIndex: 2, delay: 0.0, forward: 0.0, color: .lightGray, border: .none, size: 24.0, constraint: [centerMargin, margin]),
                PVCAnimationStyle(thenIndex: 3, delay: 0.0, forward: 0.0, color: .lightGray, border: .none, size: 24.0, constraint: [centerMargin, -100]),
            ]
        ))
        self.animations.append(animation: PVCAnimation(
            ...
            styles: [
                PVCAnimationStyle(thenIndex: 0, delay: 0.0, forward: 0.0, color: .lightGray, border: .none, size: 75.0, constraint: [margin]),
                PVCAnimationStyle(thenIndex: 1, delay: 0.0, forward: 0.0, color: .white, border: .shadow, size: 115.0, constraint: [margin + 50]),
                PVCAnimationStyle(thenIndex: 2, delay: 0.0, forward: 0.0, color: .lightGray, border: .none, size: 75.0, constraint: [margin]),
                PVCAnimationStyle(thenIndex: 3, delay: 0.0, forward: 0.0, color: .lightGray, border: .none, size: 75.0, constraint: [margin - 180]),
            ]
        ))
        self.animations.append(animation: PVCAnimation(
        ...
        self.animations.append(animation: PVCAnimation(
            ...
            styles: [
                PVCAnimationStyle(thenIndex: 0, delay: 0.5, forward: 0.0, color: .lightGray, border: .none, size: 40, constraint: [centerMargin + 5]),
                PVCAnimationStyle(thenIndex: 1, delay: 0.0, forward: 0.5, color: .clear, border: .none, size: 5, constraint: [centerMargin + centerMarginAjust * 0.7]),
                PVCAnimationStyle(thenIndex: 2, delay: 0.0, forward: 0.5, color: .clear, border: .none, size: 5, constraint: [centerMargin + centerMarginAjust * 0.7]),
                PVCAnimationStyle(thenIndex: 3, delay: 0.0, forward: 0.5, color: .clear, border: .none, size: 5, constraint: [centerMargin + centerMarginAjust * 0.7]),
            ]
        ))
        self.animations.append(animation: PVCAnimation(
            barIndex: 1, view: rightBarView, constraint: [rightBarConstraint],
            styles: [
                PVCAnimationStyle(thenIndex: 0, delay: 0.0, forward: 0.5, color: .clear, border: .none, size: 5, constraint: [centerMargin + centerMarginAjust * 0.7]),
                PVCAnimationStyle(thenIndex: 1, delay: 0.0, forward: 0.5, color: .clear, border: .none, size: 5, constraint: [centerMargin + centerMarginAjust * 0.7]),
                PVCAnimationStyle(thenIndex: 2, delay: 0.5, forward: 0.0, color: .lightGray, border: .none, size: 40, constraint: [centerMargin + 5]),
                PVCAnimationStyle(thenIndex: 3, delay: 0.0, forward: 0.5, color: .clear, border: .none, size: 5, constraint: [centerMargin + centerMarginAjust * 0.7]),
            ]
        ))
